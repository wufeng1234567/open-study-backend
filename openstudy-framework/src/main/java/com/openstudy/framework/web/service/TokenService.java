...
import com.openstudy.common.utils.ServletUtils;
import com.openstudy.common.utils.StringUtils;
import com.openstudy.common.utils.http.UserAgentUtils;
import com.openstudy.common.utils.ip.AddressUtils;
import com.openstudy.common.utils.ip.IpUtils;
import com.openstudy.common.utils.uuid.IdUtils;
...
public class TokenService {
    ...
    public void delLoginUser(String token) {
        if (StringUtils.isNotEmpty(token)) {
            ...
            if (loginUser != null) {
                String userKey = getUserTokenKey(loginUser.getUserId());
    ...
    /**
     * 设置用户Token映射（用于单点登录）
     * 如果用户已有Token，则删除旧Token
     */
    public void setUserTokenMapping(Long userId, String token) {
        String userKey = getUserTokenKey(userId);
        ...
        if (StringUtils.isNotEmpty(oldToken) && !oldToken.equals(token)) {
            ...
            log.info("用户 {} 在其他设备登录，旧Token已失效", userId);
        }
    ...
    public void refreshToken(LoginUser loginUser) {
        ...
        setUserTokenMapping(loginUser.getUserId(), loginUser.getToken());
    }
