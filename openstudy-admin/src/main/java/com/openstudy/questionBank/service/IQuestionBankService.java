package com.openstudy.questionBank.service;
...
public interface IQuestionBankService 
{
    ...
    boolean checkBankExists(Long bankId);

    // ✅ 新增：根据用户ID查询题库
    List<QuestionBank> selectQuestionBankListByUserId(Long userId);
