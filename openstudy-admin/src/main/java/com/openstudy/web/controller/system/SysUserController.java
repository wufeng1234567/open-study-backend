...
import com.openstudy.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    public TableDataInfo frontList(SysUser user) {
        startPage();
    ...
    public AjaxResult getFrontUserInfo(@PathVariable Long userId) {
